...
jQuery.fn = jQuery.prototype = {
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery init";
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery get";
...
jQuery.extend({
	...
	ready: function( wait ) {
		//jbrunelle debug		
		document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery ready0";
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery bindready";
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery attach readystatechange";
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery map";
...
if ( document.addEventListener ) {
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery firing jquery.ready();";
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery ready state complete, firing jquery.ready()";
...
function doScrollCheck() {
	...
	//jbrunelle debug		
	document.getElementById("d1").innerHTML=document.getElementById("d1").innerHTML + "<br>ve_jquery doScrollCheck() and jquery.ready()";
...
VisualEvent.prototype = {
	...
	"_construct": function ()
	{
		...
		//	alert("constructing...2." + i + ": " + accumulator + " - " + $(this.s.elements[i].node));
			sneakyDiv += i + ": " + escape(this.s.elements[i].node.innerHTML) + " - " + accumulator + "\n\n";
		}
		sneakyDiv += "\n\n\n";
