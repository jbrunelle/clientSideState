...
VisualEvent_Loader.prototype = {
	...
	"_construct": function ()
	{
		...
		/* Load the required files - note that the token //192.168.1.10/clientSideState/VisualEvent/builds/VisualEvent-1433531887 is replaced by the build
		 * script with the location of the combined Visual Event file (i.e. with the parsers included
		 */
		this._loadFile( protocol+'//192.168.1.10/clientSideState/VisualEvent/builds/VisualEvent-1433531887/css/VisualEvent.css', 'css' );
		if ( typeof jQuery == 'undefined' ) {
			this._loadFile( protocol+'//192.168.1.10/clientSideState/VisualEvent/builds/VisualEvent-1433531887/js/VisualEvent-jQuery.js', 'js' );
		}
		else {
			this._loadFile( protocol+'//192.168.1.10/clientSideState/VisualEvent/builds/VisualEvent-1433531887/js/VisualEvent.js', 'js' );
		}
	},
