...
VisualEvent_Loader.prototype = {
	...
	"_construct": function ()
	{
		...
		/* Load the required files - note that the token //localhost/clientSideState/VisualEvent/builds/VisualEvent-1435105889 is replaced by the build
		 * script with the location of the combined Visual Event file (i.e. with the parsers included
		 */
		//this._loadFile( protocol+'//localhost/clientSideState/VisualEvent/builds/VisualEvent-1435105889/css/VisualEvent.css', 'css' );
		this._loadFile( "http:"+'//localhost/clientSideState/VisualEvent/builds/VisualEvent-1435105889/css/VisualEvent.css', 'css' );
		if ( typeof jQuery == 'undefined' ) {
		//	this._loadFile( protocol+'//localhost/clientSideState/VisualEvent/builds/VisualEvent-1435105889/js/VisualEvent-jQuery.js', 'js' );
			this._loadFile( "http:"+'//localhost/clientSideState/VisualEvent/builds/VisualEvent-1435105889/js/VisualEvent-jQuery.js', 'js' );
		}
		else {
//			this._loadFile( protocol+'//localhost/clientSideState/VisualEvent/builds/VisualEvent-1435105889/js/VisualEvent.js', 'js' );
			this._loadFile( "http:"+'//localhost/clientSideState/VisualEvent/builds/VisualEvent-1435105889/js/VisualEvent.js', 'js' );
		}
	},
